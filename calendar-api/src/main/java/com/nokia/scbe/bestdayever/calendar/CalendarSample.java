...
//        showCalendars();
        ...
        /////////////
        CalendarList calendarList = showCalendars();
        for (CalendarListEntry calendarEntry : calendarList.getItems()) {
        	Events feed = client.events().list(calendarEntry.getId()).execute();
...
//        deleteCalendar(calendar);
  ...
  private static void showFreeBusy() throws IOException {
	  Freebusy freebusy = client.freebusy();
	  // TODO: Implement this
  }
